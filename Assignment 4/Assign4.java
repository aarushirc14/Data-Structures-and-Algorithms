...
public class Assign4 {
	...
	public static void checkArgs(String[] args) {
		// error checking cmd line args
		if (args.length != 7) {
			System.err.println(
					"Insufficient arguments. The program needs 7 arguments.\n1.Input\n2.Query\n3.Output1\n4.Output2\n5.DijkstraInput\n6.DijkstraQuery\n7.Output3");
			System.exit(0);
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int row = 0; row < weightedV; row++) {
				for (int col = 0; col < weightedV; col++) {
					...
					if (weight != 0)
						weightedDigraph.addWeightedEdge(weightedDigraph.weightedAdj[row],
								weightedDigraph.weightedAdj[col], weight);
				}
			}
		...
		System.out.println(
				"Done. Output in files " + output1 + " " + output2 + " " + output3 + ". Located in current directory.");
	}
