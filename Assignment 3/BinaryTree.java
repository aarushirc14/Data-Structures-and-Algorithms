...
/**
 * User created Binary Search Tree Class. The data fields in the tree are char
 * arrays.
 */
public class BinaryTree {
    ...
    /**
     * Number of times we insert into the tree will increase value. TO be safe we
     * will not count decreases
     ...
     * 
     * current Root node of tree or subtree to be searched
     * key char array to be found
     * returns a reference to the node or null if it is not found
     */
     ...
     * 
     * current Intitally should be the root node
     * writer the FileWriter object that has the stream for the output
     */
