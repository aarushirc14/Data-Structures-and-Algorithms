...
public class AVLTreeTest {
    ...
    /**
     *
     * arg[0] is the name of the input file,
     * arg[1] is the name of the ouput file which will be depth first,
     * args[2] is the name of the output file that will be breadth first
     */
