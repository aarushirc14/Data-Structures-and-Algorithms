...
/**
 * This Class creates a Binary Search Tree from an input file and outputs two
 * files, one that lists the elements
 * in chronological order, and one that lists it level by level from left to
 * right.
 */
public class BinaryTreeTest {
    ...
    /**
     *
     * @param args arg[0] is the name of the input file, arg[1] is the name of the
     *             ouput file which will be in order,
     *             args[2] is the name of the output file that will be displayed
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Done. Ouput in " + args[1] + " and " + args[2] + ". Can be located in current directory.");
    }
